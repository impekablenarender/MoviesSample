...
public class DetailsActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MOVIE_RATED = "EXTRA_MOVIE_RATED";
    ...
    private void updateUi(Movie movie) {
        // movie backdrop
        GlideApp.with(this)
                .load(getIntent().getStringExtra(EXTRA_MOVIE_POSTER_URL))
...
//                .load(Constants.IMAGE_URL + movie.getImageUrl())
        ...
        // movie title
        mBinding.textTitle.setText(getIntent().getStringExtra(EXTRA_MOVIE_TITLE));

        // movie release date
        mBinding.textReleaseDate.setText(getIntent().getStringExtra(EXTRA_MOVIE_RELEASE_DATE));

        // vote average
        mBinding.textVote.setText(getIntent().getStringExtra(EXTRA_MOVIE_RATED));

        // movie overview
        mBinding.textOverview.setText(getIntent().getStringExtra(EXTRA_MOVIE_OVERVIEW));
